<main>
  <section class="about-me" id="about-me">
    ...
    <div class="about-me__wrap">
      ...
      <div class="about-me__links-wrap">
        <a class="about-me__link about-me__link--stack-overflow" href="https://stackoverflow.com/users/9496492/irina-kovalchuk?tab=profile">
          Stack Overflow
        ...
        <a class="about-me__link about-me__link--github" href="https://github.com/foaxdev">
          GitHub
          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
               width="30" height="30" viewBox="0 0 35.318 35.318" style="enable-background:new 0 0 35.318 35.318;"
               xml:space="preserve">
<g>
    ...
    <ul class="markups-list">
      ...
      <li class="markups-list__item">
        ...
        <div class="markups-list__description-wrap">
          <button class="markups-list__description-button js-description-btn" type="button"><?=$lang[$language]["description"];?></button>
